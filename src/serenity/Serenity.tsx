...
import { Play, Pause, BookOpen, Clock, Timer, Crosshair, Scale, FlipHorizontal2, AudioWaveform, BadgeCheck, FileCheck, Lightbulb, StickyNote, BookText } from 'lucide-react';
